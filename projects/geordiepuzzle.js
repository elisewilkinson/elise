...
lib.ssMetadata = [
		{name:"geordiepuzzle_atlas_1", frames: [[0,151,132,194],[0,347,127,132],[0,0,176,149]]}
];
...
(lib.body = function() {
	this.initialize(ss["geordiepuzzle_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#FFFFFF").ss(7,2,0,3).p("ABzheIjlC9");
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-18,1,0.2886,0.2887);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(5,2,0,3).p("AgEkXIAJIv");
	this.shape.setTransform(0.5,32);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.stick, new cjs.Rectangle(-18,1,38.1,61.6), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(7,2,0,3).p("AAAhPIAACf");
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.3543,0.3409);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#66FF00").ss(5.8,2,0,3).p("AiZiYQBAg/BZAAQBaAABAA/QBABAAABYQAABZhABAQhAA/haAAQhZAAhAg/QhAhAAAhZQAAhYBAhAg");
	this.shape.setTransform(21.75,21.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AiZCZQhAhAAAhZQAAhYBAhAQBAg/BZAAQBaAAA/A/QBABAAABYQAABZhABAQg/A/haAAQhZAAhAg/g");
	this.shape_1.setTransform(21.75,21.575);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.head, new cjs.Rectangle(-2.8,-2.8,49.199999999999996,48.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#66FF00").s().p("AnaH0QhkAAAAhkIAAsfQAAhkBkAAIO1AAQBkAAAABkIAAMfQAABkhkAAg");
...
// stage content:
(lib.geordiepuzzle = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.frame_1 = function() {
		...
		function getWord() {
			var a = new Array('geordie', 'bethan', 'chloe', 'beau', 'nathan', 'mortal', 'anna', 'scottyt', 'seasontwentytwo', 'newcastle', 'sam', 'marnie', 'newcastleisbest', 'annasonthephone', 'pieoff', 'wayayeman', 'gaz', 'purelybelter', 'solution', 'conclusion', 'sandwich', 'mobile', 'occupation', 'sanity', 'psychopath', 'programmer', 'cradle', 'silencer', 'filth', 'mask', 'neighborhood', 'brotherhood', 'mother', 'father', 'suicide', 'apple', 'imbalance', 'sacrefice', 'soundtrack', 'words', 'hangman', 'confidence', 'dwarf', 'imperfect', 'police', 'officer', 'love', 'semitrailer', 'communication', 'declaration', 'equipment', 'munition', 'bullet', 'time', 'tree', 'segment', 'comment', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'business', 'comfort', 'outing', 'daredevil', 'wire', 'internet', 'computer', 'button', 'label', 'surface', 'monitor', 'keyboard', 'science', 'mythologie', 'germany', 'clown', 'friend', 'knockout', 'ring', 'television', 'radio', 'superstar', 'dungeon', 'siege', 'faction', 'purple', 'runaway', 'lord', 'destruction', 'wave', 'panzer', 'horse', 'shotgun', 'invocation', 'columbia', 'america', 'stone', 'storm', 'fire', 'vegetable', 'cartoon', 'show', 'master', 'street', 'fighter', 'child', 'faculty', 'blood', 'witch', 'cookie', 'backstroke', 'outback', 'quarter', 'quorum', 'eggbeater', 'egyptian', 'clobber', 'violence', 'voice', 'review', 'godness', 'monkey', 'elephant', 'racist', 'graphics', 'sound', 'soul', 'game', 'humor', 'darkness', 'light', 'edge', 'strength', 'length', 'hate', 'underoath', 'night', 'wish', 'sorrow', 'moon', 'hostage', 'shooting', 'weapon', 'deer', 'hunter', 'ocean', 'death', 'heaven', 'hell', 'blastbeat', 'mutation', 'mutator', 'modification', 'nail', 'representation', 'presentation', 'president', 'house', 'garden', 'food', 'fastfood', 'height', 'width', 'name', 'caption', 'captain', 'offer', 'tribute', 'monster', 'surrender', 'edition', 'commander', 'conquerer', 'mile', 'shaman', 'sexism', 'square', 'root', 'quality', 'rating', 'picture', 'image', 'illusion', 'phantasy', 'yellow', 'colour', 'neurosis', 'silliness', 'weakness', 'perspective', 'perspiration', 'reservation', 'luck', 'tongue', 'elite', 'pernicious', 'persian', 'dammage', 'flash', 'ground', 'background', 'underground', 'bender', 'soundbox', 'desktop', 'life', 'enter', 'random', 'wearing', 'stimulation', 'simulation', 'acarde', 'year', 'race', 'poster', 'beam', 'babysitter', 'geordie', 'bethan', 'chloe', 'beau', 'nathan', 'mortal', 'anna', 'scottyt', 'seasontwentytwo', 'newcastle', 'sam', 'marnie', 'newcastleisbest', 'annasonthephone', 'pieoff', 'wayayeman', 'gaz', 'purelybelter',);
	...
	// actions
	this.bad_guess = new cjs.Text("0", "bold 30px 'Myriad Pro'", "#FFFFFF");
	...
	this.bad_guess.setTransform(338.1,392.45);

	this.good_guess = new cjs.Text("0", "bold 30px 'Myriad Pro'", "#FFFFFF");
	...
	this.good_guess.setTransform(338.1,360.75);

	this.text = new cjs.Text("Bad Guess", "bold 30px 'Myriad Pro'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 39;
	this.text.lineWidth = 185;
	this.text.parent = this;
	this.text.setTransform(201.8,392.45);

	this.text_1 = new cjs.Text("Good Guess", "bold 30px 'Myriad Pro'", "#FFFFFF");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 39;
	this.text_1.lineWidth = 185;
	this.text_1.parent = this;
	this.text_1.setTransform(210.8,360.75);
	...
	this.body.name = "body";
	this.body.setTransform(248.35,210.9,2,1.7857,0,0,0,0.5,28);
	...
	// board
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(12,2,0,3).p("Ai/D8IGAn3");
	this.shape.setTransform(128.05,95.125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFFFF").ss(12,2,0,3).p("AsIAGIYQgM");
	this.shape_1.setTransform(183.8,63.95);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(12,2,0,3).p("AAAddMAAAg65");
	this.shape_2.setTransform(107.5,253.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#FFFFFF").ss(12,2,0,3).p("Ax7AAMAj3AAA");
	...
	this.instance.setTransform(216,243,0.5369,0.5369);
	...
	this.text_2 = new cjs.Text("Word is", "bold 40px 'Myriad Pro'", "#00FF00");
	...
	this.text_3 = new cjs.Text("YOU LOST", "bold 80px 'Myriad Pro'", "#FFFFFF");
	...
	this.body_1.setTransform(245.35,216.9,2,1.7857,0,0,0,0.5,28);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.leg1_1},{t:this.leg2_1},{t:this.hand1_1},{t:this.hand2_1},{t:this.body_1},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.head_1},{t:this.rope_1},{t:this.text_3},{t:this.lost_back},{t:this.text_2},{t:this.lost_word},{t:this.instance}]},2).to({state:[]},1).wait(1));
	...
	this.text_5 = new cjs.Text("Word is", "bold 40px 'Myriad Pro'", "#FFFFFF");
...
// library properties:
lib.properties = {
	id: 'CA14EE76F1D40C42AB56EC642ADBA1FD',
	width: 960,
	height: 640,
	fps: 24,
	color: "#0000FF",
	opacity: 1.00,
	manifest: [
		{src:"images/geordiepuzzle_atlas_1.png?1655178596251", id:"geordiepuzzle_atlas_1"}
	],
	preloads: []
};
...
an.compositions['CA14EE76F1D40C42AB56EC642ADBA1FD'] = {
