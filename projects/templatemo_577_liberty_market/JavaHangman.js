...
// stage content:
(lib.JavaHangman = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.bad_guess.setTransform(336,393.75);
	...
	this.good_guess.setTransform(336.45,352.6);
	...
	this.text.parent = this;
	this.text.setTransform(201.8,393.75);
	...
	this.text_1.setTransform(209.15,352.6);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.h0},{t:this.a1},{t:this.n2},{t:this.g3},{t:this.m4},{t:this.n6},{t:this.a5}]}).to({state:[]},1).to({state:[]},1).wait(2));
	...
	// lost
	this.lost_word = new cjs.Text("Word is", "bold 40px 'Myriad Pro'", "#00FF00");
	...
	this.text_5 = new cjs.Text("Word is", "bold 40px 'Myriad Pro'", "#00FF00");
	...
	this.text_6 = new cjs.Text("CONGRATS \nYOU WON", "bold 80px 'Myriad Pro'", "#FFFFFF");
...
// library properties:
lib.properties = {
	id: 'EE640F06ABD2F643BA7468E3C958186A',
	width: 960,
	height: 640,
	fps: 24,
	color: "#0099FF",
...
an.compositions['EE640F06ABD2F643BA7468E3C958186A'] = {
